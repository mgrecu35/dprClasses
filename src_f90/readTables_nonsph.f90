...
subroutine get_radarKu(zKuJ,attKuJ,pwcJ,rrateJ,dmJ,&
  ...
  real :: zKuHJ(nKuJ),attKuHJ(nKuJ),pwcHJ(nKuJ),rrateHJ(nKuJ),dmHJ(nKuJ)
  ...
  zKuHJ(1:nbins)=z13TableH(1:nbins,imu)
  attKuHJ(1:nbins)=att13TableH(1:nbins,imu)
  pwcHJ(1:nbins)=pwc13TableH(1:nbins,imu)
  rrateHJ(1:nbins)=pr13TableH(1:nbins,imu)
  dmHJ(1:nbins)=d013TableH(1:nbins,imu)
  nbinSJ=nbinS2
  print*,nbinS2,zmin,minval(zKuSJ)
end
...
subroutine get_radarKa(zKuJ,attKuJ,pwcJ,rrateJ,dmJ,&
  ...
  zKuHJ(1:nbins)=z35TableH(1:nbins,imu)
  attKuHJ(1:nbins)=att35TableH(1:nbins,imu)
  pwcHJ(1:nbins)=pwc13TableH(1:nbins,imu)
  rrateHJ(1:nbins)=pr13TableH(1:nbins,imu)
  dmHJ(1:nbins)=d013TableH(1:nbins,imu)
  nbinSJ=nbinS2
